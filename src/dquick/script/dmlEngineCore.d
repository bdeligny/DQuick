...
version(unittest)
{
	...
	class SubItem : DeclarativeItem, dquick.script.i_item_binding.IItemBinding
	{
		...
		dquick.script.native_property_binding.NativePropertyBinding!(int, SubItem, "nativeProperty")	nativePropertyProperty;
	...
	class Item : DeclarativeItem, dquick.script.i_item_binding.IItemBinding, Interface
	{
		...
		dquick.script.native_property_binding.NativePropertyBinding!(int, Item, "nativeTotalProperty")	nativeTotalPropertyProperty;
		...
		dquick.script.native_property_binding.NativePropertyBinding!(Enum, Item, "nativeEnumProperty")	nativeEnumPropertyProperty;
		enum Enum
		{
			enumVal1,
			enumVal2,
